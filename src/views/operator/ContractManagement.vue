  ...
  <div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      <div 
        ...
        @click="router.push('/admin/contract/draft')"
      >
      ...
      <div 
        ...
        class="card cursor-pointer hover:shadow-lg"
        @click="router.push('/admin/contract/countersign')"
      >
      ...
      <div 
        ...
        class="card cursor-pointer hover:shadow-lg"
        @click="router.push('/admin/contract/finalize')"
      >
      ...
      <div 
        ...
        class="card cursor-pointer hover:shadow-lg"
        @click="router.push('/admin/contract/sign')"
      >
