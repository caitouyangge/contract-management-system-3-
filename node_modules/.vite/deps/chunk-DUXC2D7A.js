    ...
    if (parent1 instanceof MemberExpression) {
      ...
      if (thenCallback.params.length === 1) {
        ...
        if (declaration instanceof Identifier2) {
          ...
          const memberExpression2 = thenCallback.body;
          if (!(memberExpression2 instanceof MemberExpression) || memberExpression2.computed || !(memberExpression2.property instanceof Identifier2)) {
            return;
          }
          const returnVariable = memberExpression2.object;
          if (!(returnVariable instanceof Identifier2) || returnVariable.name !== starName) {
            return;
          }
          return [memberExpression2.property.name];
        }
        if (declaration instanceof ObjectPattern) {
          return getDeterministicObjectDestructure(declaration);
        }
...
async function watchInternal(configs, emitter) {
  ...
  await loadFsEvents();
  const { Watcher } = await import("./watch-PE33YPVA.js");
...
rollup/dist/es/shared/node-entry.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-DUXC2D7A.js.map
